...
const ContactManagement = () => {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      currentContact.companyName.trim() === ""
    ) {
      errors.push("Company name is required");
    }

    if (
      !currentContact.companyEmail ||
      currentContact.companyEmail.trim() === ""
    ) {
  ...
  const handleSaveContact = async () => {
    ...
    try {
      ...
      console.log(
        `Successfully ${isEditing ? "updated" : "created"} contact:`,
        savedContact
      );
      ...
      setError(
        `Failed to ${isEditing ? "update" : "create"} contact. ` + err.message
      );
                      ...
                      <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="sm:hidden">
                          <div className="text-xs text-gray-500">
                            {contact.companyEmail || contact.email || "—"}
                          </div>
                          <div className="mt-1">
                            {contact.contactType ? (
                              <span
                  ...
                  <tr>
                    ...
                    >
                      {searchTerm
                        ...
                        : "No contacts available. Add your first contact to get started."}
                    </td>
                  </tr>
                )}
              </tbody>
